    ...
    <div>
        ...
        height: '400px'}}></div>
          ...
          <div className="navigate-wala">
              ...
              <p onClick={()=>navigate('/')} className='navigate-home font-style '>HOME</p> <b >|</b><p className='font-style' style={{marginLeft:"20px",fontSize:"20px",color:"#ff4757"}}>SHOULDERS</p>
              </div>
              <h1 className='font-style' style={{color:"white",fontSize:"60px",margin:"0"}}>SHOULDERS EXCERCISE</h1>
          </div>
          < hr className='hr' />
               <h1 className='font-style'>SHOULDERS</h1>
           {/* card-wala-section */}
