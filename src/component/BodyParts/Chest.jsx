    ...
    <div>
        ...
        height: '400px'}}></div>
          ...
          <div className="navigate-wala">
              ...
              <p onClick={()=>navigate('/')} className='navigate-home'>HOME</p> <b >|</b><p style={{marginLeft:"20px",fontSize:"20px",color:"#ff4757"}}>CARDIO</p>
              </div>
              <h1 style={{color:"white",fontSize:"60px",margin:"0"}}>CARDIO EXCERCISE</h1>
          </div>
          < hr className='hr' />
               <h1>CARDIO</h1>
           {/* card-wala-section */}
