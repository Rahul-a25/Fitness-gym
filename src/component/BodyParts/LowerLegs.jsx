    ...
    <div>
        ...
        height: '400px'}}></div>
          ...
          <div className="navigate-wala">
              ...
              <p onClick={()=>navigate('/')} className='navigate-home font-style'>HOME</p> <b >|</b><p className='font-style' style={{marginLeft:"20px",fontSize:"20px",color:"#ff4757"}}>LOWER LEGS</p>
              </div>
              <h1 className='font-style' style={{color:"white",fontSize:"60px",margin:"0"}}>LOWER LEGS EXCERCISES</h1>
          </div>
          < hr className='hr' />
               <h1 className='font-style'>LOWER LEGS</h1>
           {/* card-wala-section */}
