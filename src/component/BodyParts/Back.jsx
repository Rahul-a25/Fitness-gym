    ...
    <div>
        ...
        height: '400px'}}></div>
          ...
          <div className="navigate-wala">
              ...
              <p onClick={()=>navigate('/')} className='navigate-home'>HOME</p> <b >|</b><p style={{marginLeft:"20px",fontSize:"20px",color:"#ff4757"}}>BACK</p>
              </div>
              <h1 style={{color:"white",fontSize:"60px",margin:"0"}}>BACK EXCERCISE</h1>
          </div>
          < hr className='hr' />
               <h1>BACK</h1>
           {/* card-wala-section */}
